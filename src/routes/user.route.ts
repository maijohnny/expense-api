...
// Admin routes
userRouter.patch('/update-role', isAuthenticated, authorizeRoles([1, 2]), updateUserRoleByAdmin);
userRouter.patch('/update-pwd-admin', isAuthenticated, authorizeRoles([1, 2]), updateUserPwdByAdmin);
userRouter.delete('/:id', isAuthenticated, authorizeRoles([2]), deleteUser);
